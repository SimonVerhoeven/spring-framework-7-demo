...
In this case annotatating the top-level class in such hierarchies with `@SpringExtensionConfig(useTestClassScopedExtensionContext = true)` should resolve the issue.
...
There have also been a wide variety of smaller changes:
